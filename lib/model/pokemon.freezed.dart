...
class _$CriesImpl implements _Cries {
  const _$CriesImpl({this.latest, this.legacy});
...
abstract class _Cries implements Cries {
  const factory _Cries({final String? latest, final String? legacy}) =
      _$CriesImpl;
...
class _$HeldItemImpl implements _HeldItem {
  const _$HeldItemImpl({this.item, final List<VersionDetail>? versionDetails})
...
class _$VersionDetailImpl implements _VersionDetail {
  const _$VersionDetailImpl({this.rarity, this.version});
...
abstract class _GenerationV implements GenerationV {
  const factory _GenerationV({final Sprites? blackWhite}) = _$GenerationVImpl;
...
abstract class _GenerationViii implements GenerationViii {
  const factory _GenerationViii({final DreamWorld? icons}) =
